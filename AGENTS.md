...
This project is indexed by GitNexus as **UI_drawsvg** (12725 symbols, 36971 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/UI_drawsvg/context` | Codebase overview, check index freshness |
| `gitnexus://repo/UI_drawsvg/clusters` | All functional areas |
| `gitnexus://repo/UI_drawsvg/processes` | All execution flows |
| `gitnexus://repo/UI_drawsvg/process/{name}` | Step-by-step execution trace |
...
GitNexus muss bei jeder geplanten Codeänderung mitverwendet werden. Vor dem Bearbeiten
von Code ist mindestens die GitNexus-Auswirkungsanalyse (`impact`) für die betroffenen
